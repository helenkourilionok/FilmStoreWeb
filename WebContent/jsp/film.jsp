	...
	<div class="wrapper container">
		...
		<div class="wrapper row">
			...
			<section class="col-md-9">
				<c:choose>
					<c:when test="${requestScope.filmNotFound == 'true'}">
					...
					<article class="row">
						<div class="col-md-12">
							<c:choose>
								<c:when test="${listComNotFound == 'true'}">
									<h3>${noComments}</h3>
								</c:when>
								<c:otherwise>
									<h3>${comments}</h3>
						...
						<c:when
							...
							<article class="row col-md-12">
								...
								<form action="Controller" method="get">
									<input type="hidden" name="command" value="make_comment" /> <input
										type="hidden" name="userEmail"
										value="${sessionScope.userEmail}" /> <input type="hidden"
										name="filmId" value="${requestScope.film.id}" />
									<p>
