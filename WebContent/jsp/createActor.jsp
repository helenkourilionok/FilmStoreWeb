			...
			<div class="wrapper row">
				...
				<section class="col-md-9">
					<div class="col-md-6 col-md-offset-3">				
						<h2>${createActor}</h2>
						<form role="form" action="Controller" method="post" onsubmit="return createActorValidation();">
						<input type="hidden" name="command" value="a_create_actor" /> 
						    ...
						    <div class="form-group" style="margin-bottom:30px">
						    	<button type="submit" class="btn btn-primary">${createActor}</button>
						    </div>
						</form>
					</div>
				</section>
