				...
				<c:forEach var="film" items="${requestScope.listFilm}">
					<article class="row">
						<div class="col-md-4 row-offset">
							<div class="mosaic-block bar">
								<form method="get">
									<div class="mosaic-overlay">
										...
										<button title="${makeComment}" type="submit"
											class="btn btn-default btn-default-custom"
											formaction="Controller?command=comment_show_page&id=${film.id}">
								...
								<div class="mosaic-backdrop">
									<img src="Controller?command=show_image&id=${film.id}"
						...
						<div class="col-md-8 row-offset">
							...
							<b><a title="${film.name}"
								href="Controller?command=show_film_by_id&id=${film.id}">${film.name}</a></b>
