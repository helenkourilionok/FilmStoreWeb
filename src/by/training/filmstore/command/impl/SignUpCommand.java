...
public class SignUpCommand implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try {
			User user = userService.create(email, password, copyPassword, lastName, firstName, patronimic, phone,
					balance);
			...
			//localization
			request.setAttribute(SIGN_UP_FAILED,"Sign up failed!Check input data!");
